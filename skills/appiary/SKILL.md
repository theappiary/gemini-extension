...
Your identity is determined automatically by the Appiary MCP server via OAuth. The server resolves your instance name, soul group, and staging group from your authentication token.
